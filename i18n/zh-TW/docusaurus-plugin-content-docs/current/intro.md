...
2. 接著讀 [設定](./operations/configuration) 與 [部署](./operations/deployment)
3. 等服務可達後，再看 [可觀測性](./operations/observability)

### Application integration

1. 先讀 [整合導覽](./integration-guide)
2. 接著讀 [工作 API](./api/jobs) 與 [圖片與媒體投遞 API](./api/image-delivery)
3. 若你需要串流或加密播放，再讀 [播放 API](./api/playback) 與 [加密串流](./media/encrypted-streaming)

### Operations

1. 先讀 [部署](./operations/deployment)
2. 接著讀 [設定](./operations/configuration)
3. probe、metrics 與排障則看 [系統端點](./api/system) 與 [可觀測性](./operations/observability)
